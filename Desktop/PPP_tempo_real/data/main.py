...
#%% PARTE DO CODIGO QUE EXTRAI AS COORDENADAS COM AS RESPECTIVAS EPOCAS DO POS-PROCESSADO DO IBGE-PPP E SALVA UM
#ARQUIVO FORMATADO CORRETAMENTE PARA CONVERTER AS COORDENADAS GEOGRAFICAS EM COORDENADAS CARTESIANAS UTILIZANDO O 
#SOFTWARE PROGRID
...
#%%
#PARA RODAR CORRETAMENTE A PROXIMA CELULA DO CODIGO DEVE UTILIZAR A SAIDA DA CELULA ANTERIOR E CONVERTER AS COORDENADAS GEOGRAFICAS
#PARA COORDENADAS CARTESIANAS UTILIZANDO O SOFTWARE PRO-GRID DO IBGE, ESSAS COORDENADAS CARTESIANAS SAO UTILIZADAS NA PROXIMA PARTE DO CODIGO 
